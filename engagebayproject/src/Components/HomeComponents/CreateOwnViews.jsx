    ...
    <>
      <Box w={"full"} m={"auto"} mt={"10"} pt={"10"}>
        ...
        <Tabs w={"100%"} m={"auto"} mt={9}>
          <TabList w={"90%"} m={"auto"}>
            <Flex m={"auto"} w={"100%"} justify={"space-between"}>
              <Tab
                fontSize={"25px"}
                fontWeight={"700"}
                _selected={{
          ...
          <TabPanels mt={10} pt={10} w={"full"}>
            ...
            <TabPanel w={"full"}>
              ...
              >
                ...
                >
                  <Box m={"auto"} px={5}>
                    <Heading>Build Lasting Customer Relationships</Heading>
                    <Divider mt={2} />
                    <Text mt={3}>
            ...
            <TabPanel w={"full"}>
              ...
              >
                ...
                >
                  <Box m={"auto"} px={5}>
                    <Heading>Sell Like the Pros </Heading>
                    <Divider mt={2} />
                    <Text mt={3}>
            ...
            <TabPanel w={"full"}>
              ...
              >
                ...
                >
                  <Box m={"auto"} px={5}>
                    <Heading>Provide Awesome Support to Your Customers</Heading>
                    <Divider mt={2} />
                    <Text mt={3}>
